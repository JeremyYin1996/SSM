...
<script type="text/javascript">
		...
		function to_page(pn){
			...
			if(districtId==null||districtId=="" || $.trim(districtId)==""){
				$.ajax({
					url:"${APP_PATH}/categ2index/getCateg2Indices",
					data:{"pn":pn,
						  "categName":categName,
						  "indexSort":indexSort,
				...
				{
				$.ajax({
					url:"${APP_PATH}/categ2index/getCateg2IndicesWithDistrict",
					data:{"pn":pn,
						  "categName":categName,
						  "indexSort":indexSort,
						  "statisYear":statisYear,
				...
				$.ajax({
					url:"${APP_PATH}/categ2index/getCateg2IndicesWithPharm",
					data:{"pn":pn,
						  "categName":categName,
						  "indexSort":indexSort,
						  "statisYear":statisYear,
		...
		function build_all_city_index_table(result){
			...
			var categ2indices = result.extend.pageInfo.list;
			$.each(categ2indices,function(index,item){
		...
		$(document).on("click",".horiz_cmp_btn",function(){
			...
			url="${APP_PATH}/categ2index/toHorizCmpDetail?categId="+categId+"&year="+year+"&month="+month;
