...
<script type="text/javascript">
		...
		$(document).on("click",".vertic_cmp_btn",function(){
			...
			if(pharmId!=null && pharmId!="" && pharmId.trim()!="")
				{
			    	url ="${APP_PATH}/categ0index/toCateg0IndicesDetail?categId="+categId+"&pharmId="+pharmId;
				
				}
			else if(districtId!=null && districtId!="" && districtId.trim()!="")
				{
				    url ="${APP_PATH}/categ0index/toCateg0IndicesDetail?categId="+categId+"&districtId="+districtId;	
				}
			else
				url="${APP_PATH}/categ0index/toCateg0IndicesDetail?categId="+categId;
		...
		$(document).on("click",".horiz_cmp_btn",function(){
			...
			url="${APP_PATH}/categ0index/toHorizCmpDetail?categId="+categId+"&year="+year+"&month="+month;
