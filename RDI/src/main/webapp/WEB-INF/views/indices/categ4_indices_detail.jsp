...
<body>
	...
	<div class="center">
	<div class="row Top">
	 <div class="col-lg-3 col-md-4 col-sm-6  col-xs-7 col-lg-offset-1 col-md-offset-1">
	   <span id="districtname"> </span>地区最近一年的指数变化趋势：
	   </div>
	</div>
...
//绘制整个市的某类药品指数变化折线图
  function showLine(categId){
  	...
  	$.ajax({
  		url:"${APP_PATH}/categ4index/getRecentCateg4IndicesById",
  		...
  		success:function(result){
		   ...
		   for(var i=0;i<ydata2.data.length;i++){
  		 	...
  		 	buildLineNew('line-labels-upper-left',[ydata],xdata,'代表品类指数','定基指数变化趋势');
  		 	buildLineNew('line-labels-upper-right',[ydata1],xdata,'代表品类指数','环比指数变化趋势');
  		 	
  		 	buildLineNew('line-labels-lower-left',[ydata2],xdata,'代表品类指数','同比指数变化趋势');
...
//绘制某个区域的某类药品指数变化折线图
  function showLineWithDistrict(categId,districtId){
  	...
  	$.ajax({
  		url:"${APP_PATH}/categ4index/getRecentCateg4IndicesWithDistrictById",
...
function showLineWithPharm(categId,pharmId){
	...
	$.ajax({
		url:"${APP_PATH}/categ4index/getRecentCateg4IndicesWithPharmById",
